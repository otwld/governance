...
const PRODUCTION_AGENTS = ['orchestrator', 'implementer', 'reviewer', 'researcher', 'task-shaper'];
const PRODUCTION_COMMANDS = ['orchestrate', 'orchestrate-loop', 'setup-project', 'review', 'shape-task'];
