...
function validateCheckpoint(value, errors) {
  ...
  /** Later lifecycle labels are valid only when the checkpoint carries their prerequisite evidence. */
  const evidenceByStage = {
    planned: ['planDigest'],
    plan_reviewed: ['planDigest', 'planReviewDigest'],
    implementing: ['planDigest', 'planReviewDigest'],
    verified: ['planDigest', 'planReviewDigest', 'changeDigest', 'verificationDigest'],
    change_reviewed: ['planDigest', 'planReviewDigest', 'changeDigest', 'verificationDigest', 'changeReviewDigest'],
    committed: ['planDigest', 'planReviewDigest', 'changeDigest', 'verificationDigest', 'changeReviewDigest'],
    pushed: ['planDigest', 'planReviewDigest', 'changeDigest', 'verificationDigest', 'changeReviewDigest'],
    pr_open: ['planDigest', 'planReviewDigest', 'changeDigest', 'verificationDigest', 'changeReviewDigest'],
    ci_green: ['planDigest', 'planReviewDigest', 'changeDigest', 'verificationDigest', 'changeReviewDigest'],
    merged: ['planDigest', 'planReviewDigest', 'changeDigest', 'verificationDigest', 'changeReviewDigest'],
    done: ['planDigest', 'planReviewDigest', 'changeDigest', 'verificationDigest', 'changeReviewDigest'],
    blocked: ['blockerDigest'],
  };
  for (const key of evidenceByStage[value.stage] ?? []) if (value[key] === undefined) errors.push(`checkpoint.${key}: required for stage ${value.stage}`);
