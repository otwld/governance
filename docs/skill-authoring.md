...
- Prefer repository evidence and deterministic checks over conventional guesses. Include negative and malformed-input evaluations, not only a happy path.
